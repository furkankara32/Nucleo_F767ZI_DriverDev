/*
 * ex026_i2c1_it_tx_to_i2c2_slave_test.c
 *
 ...
 * ex026_i2c1_it_tx_to_i2c2_slave_test.c
 *
 * I2C1 interrupt master TX -> I2C2 polling slave RX test
 *
 * Wiring:
...
#if ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_TX_TO_I2C2_SLAVE_TEST
...
static uint8_t g_i2c1_tx_buffer[] =
{
    0x11U, 0x22U, 0x33U, 0x44U, 0x55U
};

static uint8_t g_i2c2_rx_buffer[sizeof(g_i2c1_tx_buffer)];
...
static volatile uint32_t g_i2c1_tx_complete_count = 0U;
...
static volatile uint8_t  g_i2c2_compare_ok = 0U;
static volatile uint32_t g_i2c2_addr_count = 0U;
static volatile uint32_t g_i2c2_rx_count = 0U;
static volatile uint32_t g_i2c2_stop_count = 0U;
static volatile uint32_t g_i2c2_overflow_count = 0U;
static volatile uint32_t g_i2c2_error_count = 0U;
static volatile uint32_t g_i2c2_rx_index = 0U;
...
static uint8_t I2C_CompareBuffers(uint8_t *pTxBuffer,
                                  uint8_t *pRxBuffer,
                                  uint32_t Len)
{
...
static void I2C2_SlavePoll(void)
{
    uint32_t isr;
    uint8_t rx_byte;
    ...
    /*
     * Address matched.
     * Clear ADDR flag so slave can continue.
     */
    ...
    {
        rx_byte = (uint8_t)I2C2->I2C_RXDR;

        if (g_i2c2_rx_index < sizeof(g_i2c2_rx_buffer))
        {
            g_i2c2_rx_buffer[g_i2c2_rx_index] = rx_byte;
            g_i2c2_rx_index++;
            g_i2c2_rx_count++;
        }
        else
        {
            g_i2c2_overflow_count++;
        }
    }
...
void EX026_I2C1_IT_Tx_To_I2C2_Slave_Test(void)
{
    ...
    for (uint32_t i = 0U; i < sizeof(g_i2c2_rx_buffer); i++)
    {
        g_i2c2_rx_buffer[i] = 0U;
    }
    ...
    /*
     * I2C1 master sends bytes to I2C2 slave address.
     */
    status = I2C_MasterTransmitIT(&I2C1Handle,
                                  g_i2c1_tx_buffer,
                                  sizeof(g_i2c1_tx_buffer),
                                  I2C2_SLAVE_ADDR,
                                  I2C_ADDR_MODE_7BIT,
                                  I2C_DISABLE_SR);
    ...
    while (1)
    {
        ...
        if ((g_i2c1_transfer_done == 1U) &&
            (g_i2c2_slave_done == 1U))
        {
            g_i2c2_compare_ok = I2C_CompareBuffers(g_i2c1_tx_buffer,
                                                   g_i2c2_rx_buffer,
                                                   sizeof(g_i2c1_tx_buffer));
        ...
        if (g_test_done == 1U)
        {
             ...
             * g_i2c1_tx_complete_count = 1
             * g_i2c1_nack_count = 0
             * g_i2c1_error_count = 0
             *
             * g_i2c2_addr_count = 1
             * g_i2c2_rx_count = sizeof(g_i2c1_tx_buffer)
             * g_i2c2_stop_count = 1
             * g_i2c2_compare_ok = 1
             * g_test_timeout = 0
             */
...
#endif /* ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_TX_TO_I2C2_SLAVE_TEST */
