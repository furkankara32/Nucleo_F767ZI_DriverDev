/*
 * ex029_i2c1_it_write_read_nack_test.c
 *
 ...
 * ex029_i2c1_it_write_read_nack_test.c
 *
 * I2C1 interrupt based write-read NACK test
 *
 * Flow:
 * I2C1 master tries:
 * WRITE register address to non-existing slave address
 * Expected result:
 * Address phase NACK
 *
 * Pins:
 ...
 * PB9 -> I2C1_SDA
 *
 * No external I2C device is required.
 */
...
#if ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_WRITE_READ_NACK_TEST

#define I2C_NON_EXISTING_ADDR          0x55U

static I2C_Handle_t I2C1Handle;

static uint8_t g_i2c1_reg_addr = 0x75U;
static uint8_t g_i2c1_rx_buffer[5];
...
static volatile uint8_t  g_i2c1_final_state = 0U;
static volatile uint8_t  g_i2c1_final_xfer_mode = 0U;
static volatile uint32_t g_i2c1_final_tx_len = 0U;
static volatile uint32_t g_i2c1_final_rx_len = 0U;
...
void EX029_I2C1_IT_WriteRead_NACK_Test(void)
{
    ...
    /*
     * Try write-read to non-existing slave address.
     *
     * Expected:
     * Address phase NACK before register byte is sent.
     */
    status = I2C_MasterWriteReadIT(&I2C1Handle,
                                   I2C_NON_EXISTING_ADDR,
                                   I2C_ADDR_MODE_7BIT,
                                   &g_i2c1_reg_addr,
                                   1U,
                                   g_i2c1_rx_buffer,
    ...
    while (1)
    {
        if (g_i2c1_transfer_done == 1U)
        {
            ...
            g_i2c1_final_state = I2C1Handle.TxRxState;
            g_i2c1_final_xfer_mode = I2C1Handle.XferMode;
            g_i2c1_final_tx_len = I2C1Handle.TxLen;
            g_i2c1_final_rx_len = I2C1Handle.RxLen;
        ...
        if (g_test_done == 1U)
        {
             ...
             * g_i2c1_nack_count = 1
             * g_i2c1_wr_rd_complete_count = 0
             * g_i2c1_error_count = 0
             *
             * g_i2c1_final_error_code has I2C_ERROR_NACK bit set
             * g_i2c1_final_state = I2C_READY
             * g_i2c1_final_xfer_mode = I2C_XFER_MODE_NONE
             * g_i2c1_final_tx_len = 0
             */
            while (1)
            {
            }
...
#endif /* ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_WRITE_READ_NACK_TEST */
