 ...
 * ex024_i2c1_it_nack_test.c
 *
 * I2C1 interrupt based NACK test
 *
 * Pins:
 * PB8 -> I2C1_SCL
 * PB9 -> I2C1_SDA
 * AF4
 *
 * This test sends 1 dummy byte to address 0x55.
...
#if ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_NACK_TEST

static I2C_Handle_t I2C1Handle;

static uint8_t g_i2c1_dummy_tx = 0x00U;
...
void EX024_I2C1_IT_NACK_Test(void)
{
    ...
    /*
     * Clear old flags before starting.
     */
    ...
    /*
     * Set IRQ priorities first.
     * We enable NVIC after I2C_MasterTransmitIT() for easier debugging.
     */
    ...
    /*
     * Send 1 dummy byte to an address where no device is expected.
    ...
    {
        /*
         * Enable error and event IRQ lines after transfer is prepared.
         */
                                  ...
                                  uint8_t Event)
{
    if (pI2CHandle->pI2Cx == I2C1)
    {
        ...
        else if (Event == I2C_EVENT_TX_CMPLT)
        {
            /*
             * This means some device ACKed address 0x55
             * and accepted the dummy byte.
             */
...
#endif /* ACTIVE_EXAMPLE == EXAMPLE_I2C1_IT_NACK_TEST */
